...
class CacheViewRenderer implements ViewRenderer
{
    ...
    public function render(string $template, array $data = []): string
    {
        ...
        $this->ensureCompiled($fullPathTemplate, $cache);

        return $this->bufferOutput($cache, $data);
    }

    private function ensureCompiled(string $fullPathTemplate, string $cache): void
    {
